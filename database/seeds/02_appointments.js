  ...
  return knex('appointments')
    .then(function () {
      ...
      return knex('appointments').insert([
        ...
        {title: "Meeting with John", month: 9, date: 20, year: 2021, timeStart: "12:45pm", timeEnd: "1:45pm", userId: 2},
        {title: "Celebration", month: 9, date: 24, year: 2021, timeStart: "4:45pm", timeEnd: "5:45pm", userId: 1},
        {title: "Tour the place", month: 9, date: 16, year: 2021, timeStart: "1:00pm", timeEnd: "2:00pm", userId: 2},
      ]);
    });
};